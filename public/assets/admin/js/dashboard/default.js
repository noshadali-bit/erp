(function () {
    ...
    // recent chart
    document.querySelectorAll(".recent-chart").forEach(function(chartElement) {
      var dataValue = chartElement.getAttribute("data");
    
      var chartValue = dataValue ? parseInt(dataValue) : 100;
      ...
      var recentoptions = {
        ...
        plotOptions: {
          radialBar: {
            hollow: {
              ...
              dropShadow: { enabled: true, top: 3, left: 0, blur: 4, opacity: 0.05 },
            },
            track: {
              background: "#F4F4F4",
              strokeWidth: "67%",
              margin: 0,
              dropShadow: { enabled: true, top: 0, left: 0, blur: 10, color: "#ddd", opacity: 1 },
            },
            dataLabels: {
              show: true,
              name: { offsetY: 30, show: true, color: "#888", fontSize: "12px", fontWeight: "500", fontFamily: "Rubik, sans-serif" },
              value: {
        ...
        fill: {
          ...
          gradient: {
            ...
            opacityTo: 1,
            colorStops: [
              // { offset: 0, color: "var(--theme-deafult)", opacity: 1 },
              // { offset: 20, color: "#3EA4F1", opacity: 1 },
              // { offset: 100, color: "#FFFFFF", opacity: 1 },

              { offset: 0, color: "#38C13D", opacity: 1 },
              { offset: 20, color: "#38C13D", opacity: 1 },
              { offset: 100, color: "#38C13D", opacity: 1 },
            ],
          },
        },
        ...
        labels: ["Progress"],
        responsive: [
          { breakpoint: 1840, options: { chart: { height: 260 } } },
          { breakpoint: 1700, options: { chart: { height: 250 } } },
          { breakpoint: 1660, options: { chart: { height: 230, dataLabels: { name: { fontSize: "15px" } } } } },
          { breakpoint: 1561, options: { chart: { height: 275 } } },
          { breakpoint: 1400, options: { chart: { height: 360 } } },
          { breakpoint: 1361, options: { chart: { height: 300 } } },
          { breakpoint: 1200, options: { chart: { height: 230 } } },
          { breakpoint: 1007, options: { chart: { height: 240 } } },
          { breakpoint: 600, options: { chart: { height: 230 } } },
        ],
      };
    
      // Chart initialize karna
      var recentchart = new ApexCharts(chartElement, recentoptions);
      recentchart.render();
    });
  ...
  // document.querySelector(".month-wrapper").addEventListener("click", function () {
  //   document.getElementById("monthInput").showPicker?.(); // Chrome & modern browsers
  //   document.getElementById("monthInput").focus(); // fallback for others
  // });